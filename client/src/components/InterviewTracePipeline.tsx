...
const InterviewTracePipeline = ({
  ...
  return (
    <Box sx={{ width: '100%' }}>
      {/* Horizontal Connected Stepper Line */}
      <Box
        sx={{
          display: 'flex',
          alignItems: 'center',
          ...
          <Box display="flex" alignItems="center" gap={1}>
            ...
            {activeInterview && activeInterview.status === 'COMPLETED' && (!activeInterview.feedback || activeInterview.feedback.length === 0) && (
              isOtherInterviewer ? (
                ...
                <Button
                  ...
                  sx={{ borderRadius: '6px', fontSize: '0.72rem', py: 0.3, backgroundColor: '#6366f1' }}
                >
                  Submit Scorecard
                </Button>
              )
            ...
            {activeInterview && activeInterview.status === 'COMPLETED' && activeInterview.feedback && activeInterview.feedback.length > 0 && (
              <Button
                ...
                sx={{ borderRadius: '6px', fontSize: '0.75rem', py: 0.3, backgroundColor: '#10b981', '&:hover': { backgroundColor: '#059669' } }}
              >
                View Full Scorecard
              </Button>
            )}
            ...
            {!activeInterview && (previousCompleted || isAdminOrRecruiter) && (
              isInterviewer ? (
                ...
                <Button
                  ...
                  sx={{ borderRadius: '6px', fontSize: '0.75rem', py: 0.4, backgroundColor: '#6366f1' }}
                >
